...
-- CreateIndex
CREATE UNIQUE INDEX "AcademicProgress_userId_key" ON "AcademicProgress"("userId");
...
-- AddForeignKey
ALTER TABLE "AcademicProgress" ADD CONSTRAINT "AcademicProgress_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
